...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'connectech' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'connectech package' #Capitalized
